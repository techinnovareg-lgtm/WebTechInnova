                    ...
                    <div className={styles.info}>
                        ...
                        <div className={styles.directLinks}>
                            <div className={styles.linkItem}>
                                ...
                                <a href="mailto:tech.innova.reg@gmail.com">tech.innova.reg@gmail.com</a>
                            </div>
                            <div className={styles.linkItem}>
                                <strong>WhatsApp:</strong>
                                <a href="https://wa.me/51947515529" target="_blank" rel="noopener noreferrer">+51 947 515 529</a>
                            </div>
                        </div>
                    </div>
